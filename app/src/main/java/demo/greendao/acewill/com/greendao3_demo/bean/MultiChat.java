...
public class MultiChat {
	...
	@ToMany
	@JoinEntity(entity = Linkman_MultiChat.class,sourceProperty = "multiChatId",targetProperty = "linkmanId")
	...
	public List<Linkman> getLinkmans() {
	    if (linkmans == null) {
	        ...
	        List<Linkman> linkmansNew = targetDao._queryMultiChat_Linkmans(multiChatId);
	        synchronized (this) {
	            if(linkmans == null) {
